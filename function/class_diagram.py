...
from function.gpt4_examples import class_diagram_examples

PLANT_UML_SERVER: PlantUML = PlantUML(url="http://www.plantuml.com/plantuml/img/")


def process_class_diagram_code(uml_code: str) -> str:
...
def generate_class_diagram_code(
    ...
    class_diagram_agent = GPTInstance(
        functions=[
            {
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "context_and_reasoning": {
                            "type": "string",
                            "description": "The context and reasoning necessary for the user to understand the class diagram",
                        },
                    },
    ...
    class_diagram_agent.messages += class_diagram_examples
    ...
    while retries < max_retries:
        ...
        try:
            output = class_diagram_agent(
                ...
                Can you create an initial class diagram (using plantUML) of how I can build it? You MUST respond with the class diagram and nothing else
                """
            )
            ...
            if function_call is None:
                retries += 1
                class_diagram_agent.logger.warning("ChatGPT response unsuficient. Retrying...")
                continue
